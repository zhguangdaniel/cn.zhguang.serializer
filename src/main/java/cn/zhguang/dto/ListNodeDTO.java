...
/**
 * Created by yinggang.zg on 2016/11/2 ÏÂÎç10:46 .
 */
public class ListNodeDTO implements Serializable {

	private static final long serialVersionUID = 7958172514416889411L;
	...
	public static void setStaticBigLongValue(Long staticBigLongValue) {
		ListNodeDTO.staticBigLongValue = staticBigLongValue;
	}

	public static void setStaticLongValue(long staticLongValue) {
		ListNodeDTO.staticLongValue = staticLongValue;
	}

	public static void setStaticStr(String staticStr) {
		ListNodeDTO.staticStr = staticStr;
	}
}
