 ...
 */
public class MapValueDTO implements Serializable {

	private static final long serialVersionUID = -8909260562707202226L;
	...
	public static void setStaticBigLongValue(Long staticBigLongValue) {
		MapValueDTO.staticBigLongValue = staticBigLongValue;
	}

	public static void setStaticLongValue(long staticLongValue) {
		MapValueDTO.staticLongValue = staticLongValue;
	}

	public static void setStaticStr(String staticStr) {
		MapValueDTO.staticStr = staticStr;
	}
}
