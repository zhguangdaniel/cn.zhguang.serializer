...
/**
 * Created by yinggang.zg on 2016/11/2 ÏÂÎç11:30 .
 */
public class ArrayNodeDTO implements Serializable{

	private static final long serialVersionUID = -7347328065157666219L;
	...
	public static void setStaticBigLongValue(Long staticBigLongValue) {
		ArrayNodeDTO.staticBigLongValue = staticBigLongValue;
	}

	public static void setStaticLongValue(long staticLongValue) {
		ArrayNodeDTO.staticLongValue = staticLongValue;
	}

	public static void setStaticStr(String staticStr) {
		ArrayNodeDTO.staticStr = staticStr;
	}
}
