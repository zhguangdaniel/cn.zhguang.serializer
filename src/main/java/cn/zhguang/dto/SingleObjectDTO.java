...
/**
 * Created by yinggang.zg on 2016/11/2 ÏÂÎç11:59 .
 */
public class SingleObjectDTO implements Serializable {

	private static final long serialVersionUID = 2527124505365511550L;
	...
	public static void setStaticBigLongValue(Long staticBigLongValue) {
		SingleObjectDTO.staticBigLongValue = staticBigLongValue;
	}

	public static void setStaticLongValue(long staticLongValue) {
		SingleObjectDTO.staticLongValue = staticLongValue;
	}

	public static void setStaticStr(String staticStr) {
		SingleObjectDTO.staticStr = staticStr;
	}
}