 ...
 */
public class MapKeyDTO implements Serializable {

	private static final long serialVersionUID = -6645658229137461081L;
	...
	public static void setStaticBigLongValue(Long staticBigLongValue) {
		MapKeyDTO.staticBigLongValue = staticBigLongValue;
	}

	public static void setStaticStr(String staticStr) {
		MapKeyDTO.staticStr = staticStr;
	}

	public static void setStaticLongValue(long staticLongValue) {
		MapKeyDTO.staticLongValue = staticLongValue;
	}
}
